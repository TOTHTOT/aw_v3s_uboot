...
CONFIG_INITRD_TAG=y
CONFIG_SPL_BUILD=y
CONFIG_SYS_MALLOC_LEN="(CONFIG_ENV_SIZE + (2 << 20))"
...
CONFIG_BOOTARGS="console=ttyS0,115200 panic=5 rootwait root=/dev/mmcblk0p2 earlyprintk rw  vt.global_cursor_default=0"
...
CONFIG_VIDEO_LOGO=y
CONFIG_SUNXI_MAX_FB_SIZE="(2 << 20)"
CONFIG_BOOTCOMMAND="setenv bootm_boot_mode sec; load mmc 0:1 0x41000000 zImage; load mmc 0:1 0x41800000 sun8i-v3s-licheepi-zero-dock.dtb; bootz 0x41000000 - 0x41800000;"
